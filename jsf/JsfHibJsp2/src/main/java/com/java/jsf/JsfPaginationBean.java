...
//import com.roytuts.jsf.hibernate.domain.Employ;
...
public class JsfPaginationBean implements Serializable {
	...
	private void loadCdList() {
		cdList = queryHelper.getEmployListInRange(firstRow, currentPage);
